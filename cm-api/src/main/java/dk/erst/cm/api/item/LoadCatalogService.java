...
public class LoadCatalogService {
	...
	public void saveCatalogUpdateItem(ProductCatalogUpdate productCatalogUpdate, CatalogueLine line) {
		this.productService.saveCatalogUpdateItem(productCatalogUpdate, line);
	}
}
